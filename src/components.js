// components.js
// Rev: 2026-06-16 — Gabbi 🫶 icon; special green pill button in sidebar below Dashboard.
        ...
        {groupedTabs.map(function(gp,i){
          return <div key={gp.group.id} style={{marginBottom:4}}>
            ...
            {gp.tabs.map(function(t){
              ...
              var gabbiStyle=isGabbi?{
                background:on?C.primaryDark:C.primary,
                color:"#fff",
                borderRadius:20,
                fontWeight:700,
                margin:collapsed?"6px auto":"6px 10px",
                width:collapsed?40:"calc(100% - 20px)",
                padding:collapsed?"10px":"10px 14px",
                boxShadow:on?"0 2px 8px rgba(0,0,0,0.18)":"0 1px 4px rgba(0,0,0,0.12)",
              }:{};
